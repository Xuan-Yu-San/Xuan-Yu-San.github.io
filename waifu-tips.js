...
$('.contain .l1').click(function (){
    showMessage('你可以通过这一栏选择你最近使用过的一些预设哦', 5000, true);
});
$('.contain .l2').click(function (){
    showMessage('你可以通过这一栏选择你保存过的一些预设哦', 5000, true);
});
$('.contain .l3').click(function (){
    showMessage('你可以通过这一栏选择一些常用的预设哦', 5000, true);
});
$('.text #work_title').click(function (){
    showMessage('取个好听的名字吧', 5000, true);
    work_title.infer=none;
});
...
(function (){
    var text;
    var SiteIndexUrl = 'file:///Users/xuanyuwanqiu/Desktop/live2d/demo.html';  // 手动指定主页
    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if (now > 23 || now <= 5) {
            ...
            text = '欢迎阅读<span style="color:#0099cc;">『' + document.title.split(' - ')[0] + '』</span></br>这里将会给你演示ps新建文件的小技巧哦！';
        }
